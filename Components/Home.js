...
{/* Logo And System Date Start */}
         ...
         <View style={{marginLeft:10,marginTop:30}}>
                ...
                <Text style={{color:"black",marginTop:5}}>{new Date().toDateString()} Arabic</Text>
              </View>
...
{/* Logo And System Date End */}
      ...
      <View>
        ...
        onPress={()=>this.props.navigation.navigate('Item',{Picture:'https://dj.rane.com/files/blog//64setup_traktor.png'})}>
          ...
          <Text style={{fontSize:15,color:'black',fontWeight:"bold",marginLeft:-10}}>
...
>
  ...
  <Text style={{fontSize:15,color:'black',fontWeight:"bold",marginLeft:-10}}>{I18n.t("Dell_Pc_By_Apptron")}</Text>
      <Text style={{fontSize:15,color:'black',marginBottom:5,marginRight:160}}>$900.00</Text>
  </View>
</TouchableOpacity>  
  </View>
...
<View style={{justifyContent: 'flex-end',height:"90%"}}>
    ...
    <View style={{width:150}}>
      ...
      {I18n.t("Coupon_Product")}{"\n"}{I18n.t("With_print_Function")}
